...
const Inventory = () => {
  ...
  useEffect(() => {
    (async () => {
      const url = `https://khabarchi-server-production.up.railway.app/food/${inventoryId}`;
      try {
  ...
  const handleRestock = async (e) => {
    ...
    if (reQuantity >= 1) {
      ...
      const url = `https://khabarchi-server-production.up.railway.app/update/${inventoryId}`;
      try {
